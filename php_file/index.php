...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="#">-----</a></li>
      <li><a href="#">-----</a></li>
      <a class="navbar-brand" href="#"><form method='post'> <button style="background-color: #EF711D; border: none; color:aliceblue;" id='btn' type='submit' name='logout'> LOGOUT </button> </form></a>
    </ul>
  </div>
</nav>
